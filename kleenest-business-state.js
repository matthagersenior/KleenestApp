...
(function(){'use strict';
  ...
  async function requireSession(){const session=window.KleenestAuth?.get?.()||await window.KleenestAuth?.getSession?.();if(!session)throw new Error('Please sign in to continue.');return session;}
