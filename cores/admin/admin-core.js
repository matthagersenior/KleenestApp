/* Canonical Admin Tab Core v4.2 — Dataset Control Center + wired Admin Tools + Public Data acquisition. */
export function createAdminCore({root,user=null}={}){
 ...
 async function mount(){
  ...
  await loadScript('kleenest-admin-tools-dashboard-v2.js?admin-tools=3','KleenestAdminToolsDashboardV2');
 ...
 return Object.freeze({name:'admin',version:'canonical-v4.2',mount,destroy});
}
