...
(function(){'use strict';
 ...
 load('kleenest-map-session.js?session=7').then(()=>load('kleenest-map-preloader.js?preload=23')).then(()=>load('kleenest-map-controls.js?controls=1')).then(()=>window.KleenestMapPreloader?.load?.()).catch(e=>console.warn('[Kleenest] eager Maps preload deferred',e));
