/* Canonical Admin Tab Core v4.3 — Dataset Control Center + wired Admin Tools + Public Data acquisition. */
export function createAdminCore({root,user=null}={}){
 ...
 async function mount(){
  ...
  await loadScript('kleenest-admin-tools-dashboard-v3.js?admin-tools=4','KleenestAdminToolsDashboardV3');
